...
- [x] 5.5 After a release that contains this change, archive it with the `stele-archive` skill; verify its new current specification starts with the annotation and `npm run verify:self` passes
