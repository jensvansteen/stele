# Version 0.1 implementation report
...
The supported v0.1 consumer scope is TypeScript source and named TypeScript tests executed through Node. Stele itself remains implemented and tested in Go. Consumer support for Go and other languages is future adapter work.
